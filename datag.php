        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
              <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-guru">
                  Tambah Data Guru
                </button>
                <br></br>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                  while($user_data = mysqli_fetch_array(result: $guru)) {         
                  echo "<tr>";
                  echo "<td>".$user_data['id_user']."</td>";
                  echo "<td>".$user_data['nama']."</td>";
                  echo "<td>".$user_data['mapel']."</td>";    
                  echo "<td>".$user_data['gender']."</td>";    
                  echo "<td><a href='editg.php?page=edit&& id=$user_data[id]' class='btn btn-sm btn-success'>Edit</a> <a onclick='hapusg($user_data[id])' class='btn btn-sm btn-danger'>Delete</a></td></tr>";        
                 }
                   ?>
                  </tfoot>
                </table>
        ...
        <div class="modal fade" id="modal-guru">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form method="get" action="addg.php">
                <div class="modal-body">
                  <div class="form-row">
                    ...
                    <div class="col">
                      <input type="text" class="form-control" placeholder="Mapel" name="mapel">
                    </div>
                    <div class="col">
                ...
                <div class="modal-footer justify-content-between" id="guru">
